    ...
    <div className={`min-h-screen transition-colors duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className={`text-4xl font-bold mb-4 ${
              ...
              Powerful Features for <span className={theme === 'dark' 
                ? 'bg-gradient-to-r from-purple-400 via-pink-400 to-purple-500 bg-clip-text text-transparent'
                : 'bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent'
              }>Exam Success</span>
            </h2>
      ...
      <section className={`relative z-10 py-20 ${
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <Link to="/home" className={`px-8 py-4 rounded-lg font-semibold text-lg transition transform hover:scale-105 inline-block ${
            theme === 'dark'
